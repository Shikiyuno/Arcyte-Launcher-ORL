...
OutputDir=${basedir}
OutputBaseFilename=CatalystSetup32

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${basedir}\build\win-x86\Catalyst.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "${basedir}\build\win-x86\Catalyst.jar"; DestDir: "{app}"
