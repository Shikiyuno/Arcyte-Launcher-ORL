...
cp native/build-aarch64/src/Release/Catalyst.exe build/win-aarch64/
cp target/Catalyst.jar build/win-aarch64/
...
echo Catalyst.exe aarch64 sha256sum
sha256sum build/win-aarch64/Catalyst.exe

dumpbin //HEADERS build/win-aarch64/Catalyst.exe
