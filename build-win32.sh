...
cp native/build-x86/src/Release/Catalyst.exe build/win-x86/
cp target/Catalyst.jar build/win-x86/
...
echo Catalyst.exe 32bit sha256sum
sha256sum build/win-x86/Catalyst.exe

dumpbin //HEADERS build/win-x86/Catalyst.exe
