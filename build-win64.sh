...
cp native/build-x64/src/Release/Catalyst.exe build/win-x64/
cp target/Catalyst.jar build/win-x64/
...
echo Catalyst.exe 64bit sha256sum
sha256sum build/win-x64/Catalyst.exe

dumpbin //HEADERS build/win-x64/Catalyst.exe
